...
tman.it('indexOf with NaN', function () {
...
tman.it('indexOf with +- 0', function () {
  // _.each([-0, +0], function (val) {
  var zero = -0
  assert.strictEqual(_.indexOf([1, 2, zero, zero], zero), 2)
  zero = +0
  assert.strictEqual(_.indexOf([1, 2, zero, zero], -zero), 2)
  // })
})
...
tman.it('findLastIndex', function () {
  var objects = [
